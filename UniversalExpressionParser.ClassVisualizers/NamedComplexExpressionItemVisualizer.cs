...
//{
//    public class NamedComplexExpressionItemVisualizer : ExpressionItemVisualizer<IHasNameComplexExpressionItem>
//    {
//        public NamedComplexExpressionItemVisualizer([NotNull] IValueVisualizerDependencyObjects valueVisualizerDependencyObjects, [NotNull] IObjectVisualizationContext objectVisualizationContext,
//            [NotNull] IHasNameComplexExpressionItem visualizedExpressionItem, [NotNull] string visualizedElementName, [NotNull] Type mainInterfaceType, bool addChildren) : base(valueVisualizerDependencyObjects, objectVisualizationContext, visualizedExpressionItem, visualizedElementName, mainInterfaceType, addChildren)
//        {
//        }
...
//                {
//                    if (propertyCategory.Name == VisualizerConstants.OtherPropertiesCategoryName && propertyInfo.Name == nameof(IHasNameComplexExpressionItem.NameExpressionItem))
//                    {
